      ...
      return (
         <div className={styles.MainDiv}>
            ...
            <div className={styles.Banner} >
               <img className={styles.Image} alt='no pic' src={"https://cnet2.cbsistatic.com/img/LFSS3RVwK6jizYexHjFRm1xcCOU=/940x528/2018/09/27/9ba6b21f-531b-4316-89dd-4459ba9bde36/audi-e-tron-promo.jpg"} />
