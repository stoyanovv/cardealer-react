...
const Input = (props) => {
   ...
   if (props.invalid && props.touched) {
      switch (props.name) {
         ...
         case 'password': validationError = 'Паролата трябва да е повече от 6 символа.'; break;
         case 'confirmPassword': validationError = 'Паролата трябва да е повече от 6 символа.'; break;
